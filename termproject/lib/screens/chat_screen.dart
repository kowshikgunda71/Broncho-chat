...
import 'package:termproject/screens/imageshare.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    var iconButton =
        IconButton(icon: Icon(Icons.edit), onPressed: AuthProvider().signOut());
    if (AuthProvider().flag == true) {
      Navigator.pushNamed(context, WelcomeScreen.id);
    }
    // Navigator.pushNamed(context, ProfilePage.id);
    //Implement edit profile image functionality
